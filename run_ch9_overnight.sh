#!/usr/bin/env bash
# ═══════════════════════════════════════════════════════════════════════
# Ch9 Overnight Pipeline: m04 → m05 → m05b → m05c → m06 → m07 → m08 → m08b
#
# USAGE:
...
# ── Step 7a: Per-encoder plots ────────────────────────────────────────
run_step "7a" "m08 per-encoder plots" "$T_M08" \
    "$LOGDIR/m08_${MODE,,}.log" \
    src/m08_plot.py $MODE_FLAG $SUBSET_FLAG --no-wandb \
    || { log "WARNING: m08 plots failed."; }
