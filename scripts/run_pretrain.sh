...
# Pipeline: m09(train) → m05(adapted) → m05(shuffled)
...
# ═══════════════════════════════════════════════════════════════════════
# PHASE 2: EMBEDDINGS (adapted + shuffled, both use same model)
# ═══════════════════════════════════════════════════════════════════════
WINNER_MODEL="${WINNER_OUT}/student_encoder.pt"
WINNER_ENCODER="vjepa_${WINNER_DIR}"
SHUFFLED_ENCODER="${WINNER_ENCODER}_shuffled"

run_step "winner-embed" "m05 re-embed adapted (lambda=${WINNER_LAMBDA})" "$T_M05_RE" \
...
log "Phase 2 complete: both embeddings for lambda=${WINNER_LAMBDA}"
