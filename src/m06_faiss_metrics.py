...
USAGE:
    python -u src/m06_faiss_metrics.py 2>&1 | tee logs/m06_faiss_metrics.log
    python -u src/m06_faiss_metrics.py --cpu 2>&1 | tee logs/m06_faiss_metrics_cpu.log
"""
import argparse
import json
import sys
...
def generate_plots(distances: np.ndarray, indices: np.ndarray, tags: list, k: int, output_dir: Path,
    ...
    plot_path_png = output_dir / "m06_purity_by_scene.png"
    plot_path_pdf = output_dir / "m06_purity_by_scene.pdf"
    ...
    plot_path_png = output_dir / "m06_distance_hist.png"
    plot_path_pdf = output_dir / "m06_distance_hist.pdf"
...
def main():
    ...
    output_files = [
        METRICS_FILE,
        OUTPUTS_DIR / "m06_purity_by_scene.png",
        OUTPUTS_DIR / "m06_distance_hist.png"
    ]
